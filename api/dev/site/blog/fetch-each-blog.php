...
if ($apiKey!=$expected_api_key){
	...
	if (!empty($publish_id)){
		...
		if ($page_session_check==1){
			mysqli_query($conn,"UPDATE `publish_tab` SET blog_view=blog_view+1 WHERE publish_id='$publish_id'")or die (mysqli_error($conn));
		}
	}		
	
	$select="SELECT 
		a.publish_id, a.reg_title, a.reg_pix, a.blog_view, a.updated_time, b.seo_description, b.page_url, b.page_content, b.modified_by, c.fullname
