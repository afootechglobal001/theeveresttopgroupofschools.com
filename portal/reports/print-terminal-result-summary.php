                ...
                <div class="inner-div">
                    ...
                    <script>
                        $(document).ready(function () {
                            const schoolLogo = printTerminalResultSummarySession?.branchData?.schoolLogo;
                            const logoUrl = schoolLogo ? `${schoolLogoPixPath}/${schoolLogo}` : "<?php echo $websiteUrl ?>/images/report/icon.png";

                            $("#profileSchoolLogoImg").attr("src", logoUrl).attr("alt", printTerminalResultSummarySession?.branchData?.branchName + " Logo");
                        });
                    </script>
