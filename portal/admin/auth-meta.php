...
<link href="<?php echo $websiteUrl?>/style/admin/auth-style.css?v=<?php echo $codeVersion?>" type="text/css" rel="stylesheet" />

<script src="<?php echo $websiteUrl?>/js/jquery-v3.6.1.min.js"></script>
<script src="<?php echo $websiteUrl?>/js/paramount.js?v=<?php echo $codeVersion?>"></script>
<script src="<?php echo $websiteUrl?>/js/admin/useAuth.js?v=<?php echo $codeVersion?>"></script>
