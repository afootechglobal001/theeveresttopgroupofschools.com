...
<head>
    ...
    <meta name="keywords"
        content="<?php echo $thename?>,Everest Top Group of Schools contact, Everest Top Academy Sagamu address, best schools in Sagamu contact, private schools Ogun State phone number, international schools Sagamu contact, Everest Top Schools email, Sagamu Ogun State schools near me, Everest Top Academy admission enquiry, Everest Top Group of Schools location, how to reach Everest Top Schools" />
    <meta name="description"
        content="Our mission it to provide holistic, high-quality education that nurtures intellectual, moral, and social development, equipping students with the skills, knowledge, and character needed to thrive in a rapidly changing world." />
    ...
    <section class="other-pages" data-aos="fade-in" data-aos-duration="900">
        <div class="other-pages-back-div">
            ...
            <div class="text-content-div" data-aos="fade-in" data-aos-duration="900">
                ...
                <p>Welcome to <?php echo $thename?>, where we inspire young minds, foster creativity, and empower
                ...
                <div class="main-pages-info-div">
                    <div class="about-details-back-div">
                        <div class="text-div" data-aos="fade-in" data-aos-duration="1200">
                            ...
                            <p>To be a leading center of academic excellence in Nigeria, recognized for raising future
                                leaders who are innovative, globally competitive, and committed to making a positive
                                impact in society.</p>
                        </div>
                        ...
                        <div class="text-div mission-text" data-aos="fade-in" data-aos-duration="1200">
                            ...
                            <p>To provide holistic, high-quality education that nurtures intellectual, moral, and social
                                development, equipping students with the skills, knowledge, and character needed to
                        ...
                        <div class="text-div value-text" data-aos="fade-in" data-aos-duration="1200">
                            ...
                            <ul>
                                <li><strong>Excellence</strong> – We strive for the highest standards in academics,
                                    character, and
                                    creativity.</li>
                                ...
                                <li><strong>Integrity</strong> – We uphold honesty, transparency, and moral values in
                                    all we do.</li>

                                <li><strong>Innovation</strong> – We embrace modern teaching methods and technology to
                                    prepare students
                                    for
                                    the future.</li>

                                <li><strong>Respect</strong> – We foster a culture of respect for self, others, and
                                    diverse perspectives.
                                </li>

                                <li><strong>Service</strong> – We encourage students to make meaningful contributions to
                                    their
                                    communities
                                    and the world.</li>

                                <li><strong>Global Mindset</strong> – We prepare learners to compete and collaborate in
                                    an interconnected
                                    world.</li>
                            </ul>
                        </div>
