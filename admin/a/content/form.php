        ...
        <div class="title-div">
            <ul>
                ...
                <li class="active-li" title="Page Content" id="page_content"
                    onclick="_check_page_content('page_content','page-content', '<?php echo $publish_id ?>')">Page
                    Content </li>
                <?php } ?>
...
<div class="slide-form-div animated fadeInRight">
    ...
    <div class="container-back-div">
        <div class="inner-container">
            ...
            <div>
                <button class="btn" title="SUBMIT" id="submit_btn" onclick="_addStaff();"> <i class="bi-check"></i>
                    SUBMIT </button>
            </div>
        </div>
    </div>
    ...
    <div class="profile-content-div">
            ...
            <div class="mini-profile">
                <label>
                    ...
                    <input type="file" id="profile_pix" style="display:none"
                        ...
                        onchange="Staffs.UpdatePreview(this);" />
                </label>

                <div class="text-div">
                    <h2 id="staff_login_fullname">Loading...</h2>
                    <div class="text">STATUS: <strong id="staff_status_name">Loading...</strong> | LAST LOGIN DATE:
                        <strong id="last_login_time">Loading...</strong>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="field-back-div">
            ...
            <div class="user-in">
                ...
                <div class="btn-div">
                    <button class="btn" type="button" id="update_btn" onclick="_updateStaff('<?php echo $ids ?>')">
                        UPDATE PROFILE <i class="bi-check"></i></button>
                </div>
            </div>
        </div>
    </div>
...
<div class="slide-form-div animated fadeInRight">
    ...
    <div class="container-back-div">
        <div class="inner-container">
            ...
            <label>
                <div class="pix-div">
                    <img id="event_preview_pix" src="<?php echo $website_url ?>/all-images/images/sample.jpg"
                        alt="Default Image">
                    <input type="file" id="reg_thumbnail" style="display:none"
                        accept=".jpg, .jpeg, .png, .gif, .bmp, .tiff, .webp, .svg, .avif"
                        onchange="eventPixPreview.UpdatePreview(this);" />
                </div>
            </label>
            ...
            <div>
                <button class="btn" type="button" title="SUBMIT" id="submit_btn" onclick="_addEvent('event_category');">
                    <i class="bi-check"></i> SUBMIT </button>
            </div>
        </div>
    </div>
</div>
...
<div class="slide-form-div animated fadeInRight">
    ...
    <div class="container-back-div">
        <div class="inner-container">
            ...
            <div>
                <button class="btn" type="button" title="SUBMIT" id="update_btn"
                    onclick="_updateEvent('<?php echo $page_category_id ?>','<?php echo $publish_id ?>');"> <i
    ...
    <div class="container-back-div">
        <div class="inner-container">
            ...
            <label>
                <div class="pix-div">
                    <label>
                        <img id="gallery_preview_pix" src="<?php echo $website_url ?>/all-images/images/sample.jpg"
                            alt="Default Image">
                        <input type="file" id="reg_thumbnail" style="display:none"
                            accept=".jpg, .jpeg, .png, .gif, .bmp, .tiff, .webp, .svg, .avif"
                            onchange="galleyPixPreview.UpdatePreview(this);" />
                </div>
            </label>
            ...
            <div>
                <button class="btn" title="SUBMIT" id="submit_btn" onclick="_addGallery('gallery_category');"> <i
                        class="bi-check"></i> SUBMIT </button>
            </div>
        </div>
    </div>
...
<div class="slide-form-div animated fadeInRight">
    ...
    <div class="container-back-div">
        <div class="inner-container">
            ...
            <div>
                <button class="btn" title="SUBMIT" id="update_btn"
                    onclick="_updateGallery('<?php echo $page_category_id ?>','<?php echo $publish_id ?>');"> <i
                        class="bi-check"></i> SUBMIT </button>
            </div>
        </div>
    </div>
    ...
    <div class="container-back-div">
        <div class="inner-container">
            ...
            <label>
                <div class="pix-div">
                    <label>
                        <img id="blog_preview_pix" src="<?php echo $website_url ?>/all-images/images/sample.jpg"
                            alt="Default Image">
                        <input type="file" id="reg_thumbnail" style="display:none"
                            accept=".jpg, .jpeg, .png, .gif, .bmp, .tiff, .webp, .svg, .avif"
            ...
            <div>
                <button class="btn" title="SUBMIT" id="submit_btn" onclick="_addBlog('blog_category');"> <i
                        class="bi-check"></i> SUBMIT </button>
            </div>
        </div>
    </div>
...
<div class="slide-form-div animated fadeInRight">
    ...
    <div class="container-back-div">
        <div class="inner-container">
            ...
            <div>
                <button class="btn" title="SUBMIT" id="update_btn"
                    onclick="_updateBlog('<?php echo $page_category_id ?>','<?php echo $publish_id ?>');"> <i
                        class="bi-check"></i> SUBMIT </button>
            </div>
        </div>
    </div>
    ...
    <div class="container-back-div">
        <div class="inner-container">
            ...
            <div style="margin-bottom: 20px;">
                <textarea class="text_field" style="width:100%;" rows="5" id="faq_answer"
            ...
            <div>
                <button class="btn" title="SUBMIT" id="submit_btn" onclick="_addFaq('faq_category');"> <i
                        class="bi-check"></i> SUBMIT </button>
            </div>
        </div>
    </div>
...
<div class="slide-form-div animated fadeInRight">
    ...
    <div class="container-back-div">
        <div class="inner-container">
            ...
            <div>
                <button class="btn" title="SUBMIT" id="update_btn"
                    onclick="_updateFaq('<?php echo $page_category_id ?>','<?php echo $publish_id ?>');"> <i
                        class="bi-check"></i> SUBMIT </button>
            </div>
        </div>
    </div>
...
<div class="slide-form-div animated fadeInRight">
    ...
    <div class="container-back-div">
        <div class="inner-container">
            ...
            <div>
                <button class="btn" title="SUBMIT" id="update_btn" onclick="_updateTestimony('<?php echo $ids ?>');"> <i
                        class="bi-check"></i> SUBMIT </button>
            </div>
        </div>
    </div>
...
<div class="slide-form-div animated fadeInRight">
    <div class="title-panel-div">
        <div class="inner-top">
            <span id="back_icon" style="display:none; cursor:pointer;"><i class="bi-arrow-left" style="cursor:pointer;"
                    onclick="_prev_page('account_settings_id');"></i> &nbsp;&nbsp;</span>
            <span id="panel-title"><span id="header_icon"> <i class="bi-gear"></i> </span id="app_text"> APP
                SETTINGS</span>
            <div class="close" title="Close" onclick="_alert_close();">X</div>
        </div>
    </div>
    ...
    <div class="container-back-div">
        <div class="inner-container">
            ...
            <div class="setting_detail" id="account_detail">
                ...
                <button class="btn" title="SUBMIT" id="update_btn" onclick="_updateSettings();"> <i
                        class="bi-check"></i> UPDATE ACCOUNT </button>
            </div>
            ...
            <div class="setting_detail" id="channge_password">
                ...
                <div class="text_field_container">
                    <input class="text_field" type="password" id="old_password"
                        onkeyup="_show_password_visibility('old_password','old_pass')" placeholder="" />
                    <div class="placeholder">Enter Your Old Password:</div>
                    <div class="password-container" id="old_pass"
                        onclick="_togglePasswordVisibility('old_password','old_pass')">
                        <i class="bi-eye-slash password-toggle"></i>
                    </div>
                </div>

                <div class="text_field_container">
                    <input class="text_field" type="password" id="new_password"
                        onkeyup="_show_password_visibility('new_password','new_pass')" placeholder="" />
                    <div class="placeholder">Create New Password:</div>
                    <div class="password-container" id="new_pass"
                        onclick="_togglePasswordVisibility('new_password','new_pass')">
                        <i class="bi-eye-slash password-toggle"></i>
                    </div>
                </div>

                <div class="text_field_container">
                    <input class="text_field" type="password" id="confirm_password"
                        onkeyup="_show_password_visibility('confirm_password','c_new_pass')" placeholder="" />
                    <div class="placeholder">Confirm New Password:</div>
                    <div class="password-container" id="c_new_pass"
                        onclick="_togglePasswordVisibility('confirm_password','c_new_pass')">
                        <i class="bi-eye-slash password-toggle"></i>
                    </div>
                </div>

                <div class="pswd_info" style="color:#8c8d8d"><em>At least 8 charaters required including upper & lower
                        cases and special characters and numbers.</em></div>
                <button class="btn" id="submit_btn" type="button" onclick="_changePassword();" title="CHANGE PASSWORD">
